...
const Profile = () => {
  ...
  const handleProfileUpdate = async (event) => {
    ...
    if (user) {
      ...
      navigate(`/${newProfileData.username}`);
    closeModal();
    }
  };
  ...
  return (
    <div>
      <div className="flex">
        <div className="w-[20%] border-l-slate-500 min-w-[245px]">
          <Sidebar />
        </div>
            ...
            {profileUser && (
              <main className="bg-gray-100 bg-opacity-25">
                <div className="lg:max-w-5xl lg:mx-auto mb-8">
                  <header className="flex flex-wrap items-center p-4 md:py-8">
                    <div className="md:w-3/12 md:ml-16">
                      {/* profile image */}
                      <div className="relative group w-20 h-20 md:w-40 md:h-40  overflow-hidden rounded-full">
                        ...
                        <LazyLoadImage
                          className="rounded-full h-full w-full border-2 border-pink-600 md:p-1 p-0.5 object-cover"
                          src={
                    ...
                    <div className="w-8/12 md:w-7/12 ml-4">
                      <div className="md:flex md:flex-wrap md:items-center mb-4">
                        ...
                        {user?.uid === profileUser?.id && (
                          <>
                            <button
                              className="bg-gray-300 px-3 py rounded-lg hover:bg-gray-400 flex m-2"
                              onClick={openModal}
                            >
                              Profile Update
                              <div className="pl-2">
                            ...
                            <ModalContent>
                              ...
                              <ModalBody>
                                <div className="mb-4">
                                  ...
                                  <Input
                                    className="w-full py-2 px-3 leading-tight rounded border border-gray-400 focus:border-blue-500"
                ...
                text-center p-2 text-gray-600 leading-snug text-sm"
                    ...
                    <motion.div
                      layout
                      className="grid grid-cols-3 md:gap-1 gap-1 md:p-2 p-1"
                    >
